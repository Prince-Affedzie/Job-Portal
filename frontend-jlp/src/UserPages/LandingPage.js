...
export default function WorkaflowLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:min-h-screen flex items-center justify-center overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute top-[-100px] left-[-100px] w-96 h-96 bg-blue-400/50 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob"></div>
          <div className="absolute top-1/2 right-[-150px] w-96 h-96 bg-blue-500/50 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-[-100px] left-1/2 transform -translate-x-1/2 w-96 h-96 bg-blue-300/50 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-4000"></div>
          
          {/* Additional geometric elements */}
          <div className="absolute top-1/4 left-1/4 w-32 h-32 border-2 border-blue-300/50 rounded-xl rotate-12 animate-float"></div>
          <div className="absolute bottom-1/3 right-1/4 w-24 h-24 border-2 border-blue-200/50 rounded-full animate-float animation-delay-2000"></div>
          <div className="absolute top-2/3 left-1/3 w-16 h-16 border-2 border-blue-400/50 rounded-lg rotate-45 animate-float animation-delay-4000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="mt-6 text-lg sm:text-xl text-white-900 lg:pr-12">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button onClick={() => navigate('/signup')} className="px-8 py-4 bg-blue-600 text-white rounded-xl hover:shadow-lg shadow-blue-200 text-lg transition-all duration-300 transform hover:-translate-y-1 hover:bg-blue-700">
                  Find Opportunities
                </button>
                <button onClick={() => navigate('/signup')} className="px-8 py-4 bg-white text-blue-700 rounded-xl border border-blue-200 hover:border-blue-400 hover:shadow-md hover:shadow-blue-100 transition-all duration-300 text-lg transform hover:-translate-y-1">
                  Post Work
                </button>
              </div>
              <p className="mt-8 text-blue-700 flex items-center justify-center lg:justify-start">
            ...
            <div className="lg:w-1/2 mt-12 lg:mt-0">
              <div className="relative p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-blue-100 border border-blue-100">
                <div className="h-64 bg-blue-50 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-20 h-20 bg-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                      <Briefcase className="text-white" size={40} />
                    </div>
                    <h3 className="text-xl font-bold text-white-800">Your Next Opportunity Awaits</h3>
                    <p className="text-blue-600 mt-2">Start your journey with WorkaFlow today</p>
                  </div>
                </div>
                
                {/* Abstract decorative elements */}
                <div className="absolute -top-6 -left-6 w-12 h-12 bg-blue-200 rounded-lg rotate-12 z-0"></div>
                <div className="absolute -bottom-8 -right-8 w-20 h-20 bg-blue-300 rounded-full z-0"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent inline-block">Who We Serve</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 relative">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl transform transition-transform hover:-translate-y-2 duration-300 border border-blue-100 relative overflow-hidden group hover:shadow-blue-100">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-blue-900 mb-4">For Talent</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl transform transition-transform hover:-translate-y-2 duration-300 border border-blue-100 relative overflow-hidden group hover:shadow-blue-100">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-blue-900 mb-4">For Businesses</h3>
                <p className="text-white-700 mb-6">
      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent inline-block">How WorkaFlow Works</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-blue-700 mx-auto my-6 rounded-full"></div>
            <p className="mt-4 text-xl text-white-800 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 mt-12">
            {/* For Talent */}
            <div>
              <h3 className="text-2xl font-bold text-blue-900 mb-8 text-center">For Talent</h3>
