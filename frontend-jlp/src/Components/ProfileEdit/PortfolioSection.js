                ...
                <div key={index} className="relative">
                  ...
                  {editSection === "portfolio" && (
                    <button
                      ...
                      className="absolute top-3 right-3 p-2 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
